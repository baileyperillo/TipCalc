...
fun TipCalcLayout() {
    ...
    Column(
        ...
        Text(
            ...
            modifier = Modifier.padding( bottom = 10.dp, top = 40.dp).align(alignment = Alignment.Start)

        )
        //edited keyboard options
        EditNumberField(
...
@Composable
fun EditNumberField(
    //hardcoded string/ string resource = integer is used to find matching string resource
    @StringRes label: Int,
